...
def parse_args():
    ...
    parser.add_argument(
        "--data_cache_dir", type=str, default='/home/jiang/projects/binary/binkit/dataset/gnu/angr/tmp',
...
def main():
    ...
    accelerator = Accelerator(fp16=True, kwargs_handlers=[kwargs])
    ...
    with accelerator.main_process_first():
        tokenized_datasets = raw_datasets.map(
            ...
            cache_file_names={k: os.path.join(args.data_cache_dir, experiment_name, f'{k}-tokenized') for k in
                              raw_datasets},
